      ...
      <div class="container">
        ...
        <table style="border: 0.5px solid red;">
            ...
            <tr align="center" style="background-color: black;">
                ...
                <td style="padding: 10px; color:white;"> <a class="btn btn-danger" onclick="return confirm('are you sure to delete this appiontment')" href="{{url('cancel_appoint',$appoints->id)}}">Cancel</a></td>
            </tr>
